...
1. **Clone the repository**
   ```bash
   git clone https://github.com/premchand505/SLIDES_GEN.git
   cd SLIDES_GEN
   ```
...
5. Commit with clear messages  
   ```bash
   git commit -m "feat: add chart support to slides"
   ```
...
**Live App:** [https://slides-genai.vercel.app](https://slides-genai.vercel.app)  
**Source Code:** [https://github.com/premchand505/SLIDES_GEN](https://github.com/premchand505/SLIDES_GEN)  
**My Website:** [https://premchandgeddada.com](https://premchandgeddada.com)
```